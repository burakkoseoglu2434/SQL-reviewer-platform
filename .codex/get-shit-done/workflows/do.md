...
```bash
INIT=$(node "C:/Users/burak/OneDrive - RNV ANALYTİCS TEKNOLOJİ VE DANIŞMANLIK ANONİM ŞİRKETİ/Desktop/RNV/Reviewer/.codex/get-shit-done/bin/gsd-tools.cjs" state load 2>/dev/null)
```
