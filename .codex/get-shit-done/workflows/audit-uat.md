...
```bash
AUDIT=$(node "C:/Users/burak/OneDrive - RNV ANALYTİCS TEKNOLOJİ VE DANIŞMANLIK ANONİM ŞİRKETİ/Desktop/RNV/Reviewer/.codex/get-shit-done/bin/gsd-tools.cjs" audit-uat --raw)
```
